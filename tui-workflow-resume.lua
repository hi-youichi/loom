...
-- Arch:  8-phase pipeline (resume version, Phase 0 already done)
...
local function ctx(extra)
  return "项目路径: " .. BASE .. "\n"
      ...
      .. "Phase 0 已完成的设置: Cargo.toml (ratatui 依赖), mod.rs (pub mod render), render.rs (Renderable trait 骨架)\n"
      .. "现有依赖: crossterm 0.29 (已启用), ratatui 0.29 (已启用), tokio, tokio-stream, libc\n"
      .. extra
end
