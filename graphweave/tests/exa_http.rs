...
//!
//! ```bash
//! cargo test -p graphweave exa_http -- --ignored
//! ```

mod init_logging;

use graphweave::tool_source::{McpToolSource, ToolSource};
...
#[ignore = "requires EXA_API_KEY and network; run with: cargo test -p graphweave exa_http -- --ignored"]
