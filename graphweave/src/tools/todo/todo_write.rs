//! Todo-write tool: replace todo list at XDG state home (e.g. ~/.local/state/graphweave/todos.json).
//!
...
//! Effective definition for LLM comes from `graphweave/tools/todo_write.yaml` via [`YamlSpecToolSource`](crate::tool_source::YamlSpecToolSource) override.
...
///
/// Path is `state_home()/graphweave/todos.json`; creates parent dirs if needed.
...
impl Tool for TodoWriteTool {
    ...
    /// Minimal spec; overridden by `graphweave/tools/todo_write.yaml` in YamlSpecToolSource.
