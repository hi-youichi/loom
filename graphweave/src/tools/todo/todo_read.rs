//! Todo-read tool: read todo list from XDG state home (e.g. ~/.local/state/graphweave/todos.json).
//!
...
//! Effective definition for LLM comes from `graphweave/tools/todo_read.yaml` via [`YamlSpecToolSource`](crate::tool_source::YamlSpecToolSource) override.
...
impl Tool for TodoReadTool {
    ...
    /// Minimal spec; overridden by `graphweave/tools/todo_read.yaml` in YamlSpecToolSource.
