//! Skill tool: load a skill by name from a skills directory (e.g. .graphweave/skills).
...
const SKILLS_SUBDIR: &str = ".graphweave/skills";
...
impl Tool for SkillTool {
    ...
    fn spec(&self) -> crate::tool_source::ToolSpec {
        crate::tool_source::ToolSpec {
            ...
            description: Some(
                "Load a skill by name from the skills directory (.graphweave/skills). \
