...
//! ```
//!
//! Run the echo example: `cargo run -p graphweave-examples --example echo -- "hello, world!"`
//!
//! ## Examples
//!
//! See the `graphweave-examples` crate: `echo`, `react_linear`, `react_mcp`, `react_exa`, `react_memory`,
