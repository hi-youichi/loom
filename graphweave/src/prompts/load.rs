...
//!
//! **Canonical source**: Default prompt text lives in `graphweave/prompts/*.yaml`; they are
...
/// Embedded default YAML (canonical source: `graphweave/prompts/*.yaml`).
...
/// Returns default prompts by parsing the embedded YAML in `graphweave/prompts/*.yaml`.
///
...
///
/// Default text comes from `graphweave/prompts/*.yaml` (embedded), not from Rust const.
