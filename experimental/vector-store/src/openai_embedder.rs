...
//!
//! **Interaction**: Implements [`Embedder`]; used by [`LanceStore`](crate::LanceStore) for vector search.
//!
...
///
/// **Interaction**: Implements [`Embedder`]; used by [`LanceStore`](crate::LanceStore).
///
/// # Examples
///
/// ```ignore
