...
//! Run: `cargo run -p anureo-examples --example memory_persistence -- "hello"`

use async_trait::async_trait;
use anureo_graph_core::{Agent, AgentNode, StateGraph, END, START};
use anureo_llm::{error::GraphError, message::Message};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let path = env::var("ANUREO_CHECKPOINT_DB")
