...
4. **For file-writing tasks**, tell the agent which tool to use and the exact
   path.
...
| Aspect                | BAD          | GOOD                                              |
| --------------------- | ------------ | ------------------------------------------------- |
| File path             | Implicit     | Explicit (`mod.path`)                             |
| What to find          | "issues"     | 3 numbered criteria                               |
| Output format         | Implicit     | Schema + required fields                          |
| Scope                 | Unbounded    | "Read the source files" — limited set             |
| Tone                  | Imperative   | Role-setting ("You are reviewing...")             |