...
use crate::run::review_prompts::{select_review_prompt, COMBINED_REVIEW_PROMPT};
use crate::run::review_tools::{review_tool_specs, ReviewAction, ReviewToolExecutor};
        ...
        loop {
            ...
            for tc in &response.tool_calls {
                ...
                messages.push(Message::Tool {
                    ...
                    content: loom::tool_source::ToolCallContent::Text(result_str),
                });
