...
//!
//! Unlike Checkpointer, which stores one run's execution snapshots, Store
//! is meant for durable application data such as user preferences, memories, or indexed documents.
//!
//! ## Core Types
//!
...
///
/// For key-value or string-filter search (e.g. InMemoryStore, SqliteStore),
...
/// contrast, Checkpointer is for execution snapshots and resume state.
///
/// ## Core Operations
///
