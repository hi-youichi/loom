//! Fuzzy find-and-replace engine.
//!
//! Tries multiple matching strategies in priority order to robustly find and
//! replace text even when indentation, whitespace, or escape sequences differ
//! slightly from the actual file content.
//!
...
//! 7. [`trimmed_boundary_replacer`] – trim leading/trailing whitespace from `old_string`
//! 8. [`context_aware_replacer`] – anchor on first/last line; ≥50% middle-line match
//! 9. [`multi_occurrence_replacer`] – yields all exact matches (enables `replace_all`)
//!
//! # Memory safety
//!
