...
pub fn log_node_state<S: Debug>(_node_id: &str, _state: &S) {
...
pub fn log_node_complete(node_id: &str, next: &crate::next::Next) {
...
mod tests {
    ...
    fn test_logging_functions() {
        ...
        log_node_complete("test_node", &crate::next::Next::Continue);
