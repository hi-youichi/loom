...
pub fn register_file_tools(
    ...
    aggregate.register_sync(Box::new(DateTool::new()));
    Ok(())
}
...
impl FileToolSource {
    ...
    ///
    /// ```no_run
    /// use loom_tools::tool_source::FileToolSource;
    /// use std::path::Path;
    /// # fn main() -> Result<(), loom_tools::tool_source::ToolSourceError> {
