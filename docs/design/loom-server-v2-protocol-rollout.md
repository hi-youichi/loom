...
25. [x] **TUI 冒烟 + 单元测试 + 文档同步 + 提交清理**（合并 P3.13-17）：
    ...
    - 更新 `docs/rust-agent-client-protocol-index.md`，标记 loom-server 已实现的 v1/v2 端点，引用本文档
...
- 验证: `scripts/check-protocol.sh` 全绿；`bunx tui` 走完 10 个交互动作（`tui-interaction-trace.md:11-625`）；`docs/rust-agent-client-protocol-index.md` 同步更新
- 风险: 低
